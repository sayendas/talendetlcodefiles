...
public class TSortOutBeginJava
{
  ...
  protected final String TEXT_95 = NL + NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t} finally {" + NL + "\t\t\tif (dis != null) {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tdis.close();" + NL + "            } catch (java.io.IOException e) {" + NL + "            \te.printStackTrace();" + NL + "         \t}" + NL + "        \t}" + NL + "     \t}" + NL + "" + NL + "   \treturn result;" + NL + "   }" + NL + "" + NL + "\tpublic byte[] toByteArray() {" + NL + " \t\tjava.io.ByteArrayOutputStream bao = null;" + NL + "\t\tjava.io.DataOutputStream dos = null;" + NL + "\t\tbyte[] result = null;" + NL + "" + NL + " \t\ttry {" + NL + "\t\t\tbao = new java.io.ByteArrayOutputStream();" + NL + "\t\t\tdos = new java.io.DataOutputStream(bao);";
  protected final String TEXT_96 = NL + "\t\t\tdos.write";
  protected final String TEXT_97 = "(this.";
  protected final String TEXT_98 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\tif(this.";
  protected final String TEXT_100 = " == null) {" + NL + "\t\t\t\tdos.writeInt(-1);" + NL + "\t\t\t} else {" + NL + "\t\t\t\tbyte[] byteArray = this.";
  protected final String TEXT_101 = ".getBytes(utf8Charset);" + NL + "\t\t\t\tdos.writeInt(byteArray.length);" + NL + "\t\t\t\tdos.write(byteArray);" + NL + "\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_102 = " == null) {" + NL + "\t\t\t\tdos.writeInt(-1);" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdos.writeInt(this.";
  protected final String TEXT_103 = ".length);" + NL + "\t\t\t\tdos.write(this.";
  protected final String TEXT_104 = ");" + NL + "\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_105 = " == null) {" + NL + "\t\t\t\tdos.writeByte(-1);" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdos.writeByte(0);" + NL + "\t\t\t\tdos.writeLong(this.";
  protected final String TEXT_106 = ".getTime());" + NL + "\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_107 = " == null) {" + NL + "\t\t\t\tdos.writeInt(-1);" + NL + "\t\t\t} else {" + NL + "\t\t\t\tjava.io.ByteArrayOutputStream bao_";
  protected final String TEXT_108 = " = new java.io.ByteArrayOutputStream();" + NL + "            \tjava.io.ObjectOutputStream oos_";
  protected final String TEXT_109 = " = new java.io.ObjectOutputStream(bao_";
  protected final String TEXT_110 = ");" + NL + "            \toos_";
  protected final String TEXT_111 = ".writeObject(this.";
  protected final String TEXT_112 = ".close();" + NL + "            \tbyte[] byteArray = bao_";
  protected final String TEXT_113 = ".toByteArray();" + NL + "\t\t\t\tdos.writeInt(byteArray.length);" + NL + "\t\t\t\tdos.write(byteArray);" + NL + "\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_114 = " == null) {" + NL + "\t\t\t\tdos.writeByte(-1);" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdos.writeByte(0);" + NL + "\t\t\t\tdos.write";
  protected final String TEXT_115 = NL + "    \t} catch (java.lang.Exception e) {" + NL + "     \t\tthrow new RuntimeException(e);" + NL + "\t\t} finally {" + NL + "     \t\tif (dos != null) {" + NL + "         \t\ttry {" + NL + "            \t\tdos.close();" + NL + "           \t\t} catch (java.io.IOException e) {" + NL + "        \t\t\te.printStackTrace();" + NL + "          \t\t}" + NL + "        \t}" + NL + "     \t}" + NL + "     \tresult = bao.toByteArray();" + NL + "    \treturn result;" + NL + "  \t}" + NL + "" + NL + "" + NL + "}" + NL + "// /////////////////////////////////";
  protected final String TEXT_116 = NL + "  java.io.File dir_";
  protected final String TEXT_117 = " = new java.io.File(";
  protected final String TEXT_118 = ");" + NL + "  if (!dir_";
  protected final String TEXT_119 = ".exists()){" + NL + "    dir_";
  protected final String TEXT_120 = ".mkdirs();" + NL + "  }" + NL + "  dir_";
  protected final String TEXT_121 = " = null;";
  protected final String TEXT_122 = NL + NL + "org.talend.designer.components.tsort.io.sortimpl.FlowSorterIterator<";
  protected final String TEXT_123 = "StructILightSerializable> iterator_";
  protected final String TEXT_124 = " = new org.talend.designer.components.tsort.io.sortimpl.FlowSorterIterator<";
  protected final String TEXT_125 = "StructILightSerializable>();" + NL + "iterator_";
  protected final String TEXT_126 = ".setBufferSize(";
  protected final String TEXT_127 = ");" + NL + "iterator_";
  protected final String TEXT_128 = ".setILightSerializable(new ";
  protected final String TEXT_129 = "StructILightSerializable());" + NL + "iterator_";
  protected final String TEXT_130 = ".workDirectory = ";
  protected final String TEXT_131 = " + \"/\" + jobName + \"";
  protected final String TEXT_132 = " _\" + Thread.currentThread().getId() + \"_\" + pid;" + NL + "iterator_";
  protected final String TEXT_133 = ".initPut(\"\");" + NL;
