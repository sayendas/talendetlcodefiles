...
public class THashBeginJava
{
  ...
  protected final String TEXT_15 = "Struct>();" + NL + "\t\t\t            }" + NL + "\t\t\t            globalMap.put(\"tHash_";
  protected final String TEXT_16 = "\", tHash_";
  protected final String TEXT_17 = ");" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_18 = NL + "\t\t\t\tjava.util.Map<";
  protected final String TEXT_19 = "Struct>();" + NL + "\t            globalMap.put(\"tHash_";
