...
public class TMysqlOutputEndJava {
  ...
  protected final String TEXT_36 = NL + "\t\t            if(bufferL";
  protected final String TEXT_37 = "==null){" + NL + "\t\t                ";
  protected final String TEXT_38 = ".setNull(count";
  protected final String TEXT_39 = ",java.sql.Types.CHAR);" + NL + "\t                ";
  protected final String TEXT_40 = ",java.sql.Types.DATE);" + NL + "\t                ";
  protected final String TEXT_41 = ",java.sql.Types.ARRAY);" + NL + "\t                ";
  protected final String TEXT_42 = ",java.sql.Types.INTEGER);" + NL + "\t                ";
  protected final String TEXT_43 = ",java.sql.Types.VARCHAR);" + NL + "\t                ";
  protected final String TEXT_44 = ",java.sql.Types.OTHER);" + NL + "\t                ";
  protected final String TEXT_45 = ",java.sql.Types.BOOLEAN);" + NL + "\t                ";
  protected final String TEXT_46 = ",java.sql.Types.DOUBLE);" + NL + "\t                ";
  ...
  protected final String TEXT_51 = NL + "\t\t            if((\"null\").equals(String.valueOf(bufferL";
  protected final String TEXT_52 = ").toLowerCase())){" + NL + "\t\t        ";
  protected final String TEXT_53 = NL + "\t            ";
  protected final String TEXT_54 = ",java.sql.Types.CHAR);" + NL + "" + NL + "\t\t        } else if(bufferL";
  protected final String TEXT_55 = " == '\\0') {" + NL + "" + NL + "\t\t            ";
  protected final String TEXT_56 = ".setString(count";
  protected final String TEXT_57 = ",\"\");" + NL + "" + NL + "\t\t        } else {" + NL + "" + NL + "\t\t            ";
  protected final String TEXT_58 = ",String.valueOf(bufferL";
  protected final String TEXT_59 = "));" + NL + "\t\t        }" + NL + "\t\t        ";
  protected final String TEXT_60 = "!=null){" + NL + "\t\t                // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t                date_";
  protected final String TEXT_61 = " = bufferL";
  protected final String TEXT_62 = ".getTime();" + NL + "\t\t                if (date_";
  protected final String TEXT_63 = " < year1_";
  protected final String TEXT_64 = " || date_";
  protected final String TEXT_65 = " >= year10000_";
  protected final String TEXT_66 = ") {" + NL + "\t\t                    ";
  protected final String TEXT_67 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t                } else {" + NL + "\t\t                    ";
  protected final String TEXT_68 = ".setTimestamp(count";
  protected final String TEXT_69 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_70 = "));" + NL + "\t\t                }" + NL + "\t\t            }else{" + NL + "" + NL + "\t\t                ";
  protected final String TEXT_71 = ",java.sql.Types.DATE);" + NL + "" + NL + "\t\t            }" + NL + "\t\t            ";
  protected final String TEXT_72 = NL + "\t\t            ";
  protected final String TEXT_73 = ".set";
  protected final String TEXT_74 = "(count";
  protected final String TEXT_75 = ",bufferL";
  protected final String TEXT_76 = ");" + NL + "\t\t            ";
  protected final String TEXT_77 = NL + NL + "\t\t            }" + NL + "" + NL + "\t\t        ";
  protected final String TEXT_78 = NL + NL + NL + "\t    if(rowCount";
  protected final String TEXT_79 = "!=0){" + NL + "" + NL + "\t        StringBuilder extendInsertValueStmt = new StringBuilder();" + NL + "\t        for(int i=0 ; i < rowCount";
  protected final String TEXT_80 = " ; i++){" + NL + "\t             extendInsertValueStmt.append(\"(\"+insertColValue";
  protected final String TEXT_81 = "+\")\");" + NL + "\t             if (i != rowCount";
  protected final String TEXT_82 = " - 1) extendInsertValueStmt.append(\",\");" + NL + "\t        }" + NL + "" + NL + "" + NL + "\t\t\t\t   insert_";
  protected final String TEXT_83 = " = \"INSERT INTO `\"+";
  protected final String TEXT_84 = "+\"` (\"+insertColName";
  protected final String TEXT_85 = "+\") VALUES \"+extendInsertValueStmt.toString();" + NL + "\t\t\t\t   ";
  protected final String TEXT_86 = NL + "\t\t\t\t    ";
  protected final String TEXT_87 = NL + "\t\t\t\t\t\tinsert_";
  protected final String TEXT_88 = " += \" ON DUPLICATE KEY UPDATE \";" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_89 = " = new StringBuffer(\"\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_91 = ".append(\",\");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_93 = ".append (\"`\" +  ";
  protected final String TEXT_94 = " + \"`\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_95 = ".append (\"=\");" + NL + "\t\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_96 = ".append (";
  protected final String TEXT_97 = ");" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_98 = " += \tduplidateClause_";
  protected final String TEXT_99 = ".toString();" + NL + "\t\t\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\t        ";
  protected final String TEXT_101 = NL + NL + NL + "\t        pstmt_";
  protected final String TEXT_102 = " = conn_";
  protected final String TEXT_103 = ".prepareStatement(insert_";
  protected final String TEXT_104 = ");" + NL + "" + NL + "\t        int row2Count";
  protected final String TEXT_105 = " = 0;";
  protected final String TEXT_106 = NL + "\t        \tint count";
  protected final String TEXT_107 = " = 1;";
  protected final String TEXT_108 = NL + "\t\t\t    int count";
  protected final String TEXT_109 = NL + NL + "\t        for(BufferLine_";
  protected final String TEXT_110 = " bufferL";
  protected final String TEXT_111 = " : exInsertColValueList";
  protected final String TEXT_112 = "){";
  protected final String TEXT_113 = NL + "                    count";
  protected final String TEXT_114 = " = row2Count";
  protected final String TEXT_115 = "*";
  protected final String TEXT_116 = "+1;";
  protected final String TEXT_117 = NL + "\t                    count";
  protected final String TEXT_118 = "++;" + NL + "\t                    ";
  protected final String TEXT_119 = NL + "                        int count_dyn_";
  protected final String TEXT_120 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_121 = ", pstmt_";
  protected final String TEXT_122 = ", count";
  protected final String TEXT_123 = "-1, \"";
  protected final String TEXT_124 = "\");" + NL + "                        count";
  protected final String TEXT_125 = "+=count_dyn_";
  protected final String TEXT_126 = ";";
  protected final String TEXT_127 = NL + "\t            row2Count";
  protected final String TEXT_128 = "++;";
  protected final String TEXT_129 = NL + "                    commitCounter_";
  protected final String TEXT_130 = " += exInsertColValueList";
  protected final String TEXT_131 = ".size();";
  protected final String TEXT_132 = NL + "\t        }" + NL + "\t        try{" + NL + "\t        \tinsertedCount_";
  protected final String TEXT_133 = " = insertedCount_";
  protected final String TEXT_134 = " + pstmt_";
  protected final String TEXT_135 = ".executeUpdate();" + NL + "\t        }catch(java.lang.Exception e){" + NL + "\t        \t";
  ...
  protected final String TEXT_139 = NL + "                try {" + NL + "                \t\tif (batchSizeCounter_";
  protected final String TEXT_140 = " != 0) {" + NL + "\t\t\t\t\t\t\tint countSum_";
  protected final String TEXT_141 = " = 0;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_143 = ": pstmt_";
  protected final String TEXT_144 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_145 = " += (countEach_";
  protected final String TEXT_146 = " == java.sql.Statement.EXECUTE_FAILED ? 0 : 1);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_147 = NL + "\t            \t    \t";
  protected final String TEXT_148 = NL + "\t            \t    \t\tinsertedCount_";
  protected final String TEXT_149 = " += countSum_";
  protected final String TEXT_150 = ";" + NL + "\t            \t    \t";
  protected final String TEXT_151 = NL + "            \t    \t}" + NL + "" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_152 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_153 = NL + "                \tint countSum_";
  protected final String TEXT_154 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_155 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_156 = " < 0 ? 0 : countEach_";
  protected final String TEXT_157 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_158 = NL + "            \t    insertedCount_";
  protected final String TEXT_159 = ";" + NL + "\t    \t    \t";
  protected final String TEXT_160 = NL + "\t\t\t\t\tglobalMap.put(currentComponent+\"_ERROR_MESSAGE\",e.getMessage());" + NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_161 = NL + "                }" + NL + "                batchSizeCounter_";
  protected final String TEXT_162 = NL + "    \t\t";
  protected final String TEXT_163 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_164 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_165 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_166 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_167 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_168 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_169 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_170 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_171 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_172 = "\");" + NL + "        }";
  protected final String TEXT_173 = NL + "\t";
  protected final String TEXT_174 = NL + "    try {" + NL + "    \tif(pstmt_";
  protected final String TEXT_175 = " != null){" + NL + "\t\t\tint countSum_";
  protected final String TEXT_176 = " = 0;" + NL + "\t\t\t";
  protected final String TEXT_177 = NL + "\t\t\tfor(int countEach_";
  protected final String TEXT_178 = ".executeBatch()) {" + NL + "\t\t\t\tcountSum_";
  protected final String TEXT_179 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_180 = NL + "\t    \t";
  protected final String TEXT_181 = NL + "\t    \t\tupdatedCount_";
  protected final String TEXT_182 = ";" + NL + "\t    \t";
  protected final String TEXT_183 = NL + "\t    \t    deletedCount_";
  protected final String TEXT_184 = NL + "\t    }" + NL + "    }catch (java.sql.BatchUpdateException e){" + NL + "    \t";
  protected final String TEXT_185 = NL + "    \t\tthrow(e);" + NL + "    \t";
  protected final String TEXT_186 = NL + "    \tint countSum_";
  protected final String TEXT_187 = " = 0;" + NL + "\t\tfor(int countEach_";
  protected final String TEXT_188 = ": e.getUpdateCounts()) {" + NL + "\t\t\tcountSum_";
  protected final String TEXT_189 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_190 = NL + "    \tupdatedCount_";
  protected final String TEXT_191 = ";" + NL + "    \t";
  protected final String TEXT_192 = NL + "    \tdeletedCount_";
  protected final String TEXT_193 = NL + "    \tSystem.err.println(e.getMessage());" + NL + "    \t";
  protected final String TEXT_194 = NL + "\t}";
  protected final String TEXT_195 = NL + NL + "        if(pstmt_";
  protected final String TEXT_196 = " != null) {" + NL + "\t\t\t";
  protected final String TEXT_197 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_198 = ".close();" + NL + "\t\t\t\tresourceMap.remove(\"pstmt_";
  protected final String TEXT_199 = "\");" + NL + "\t\t\t";
  protected final String TEXT_200 = NL + "\t\t\t\tSharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_201 = ");" + NL + "\t\t\t";
  protected final String TEXT_202 = NL + "        }";
  protected final String TEXT_203 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_204 = "\", true);";
  protected final String TEXT_205 = NL + "    \tif (commitCounter_";
  protected final String TEXT_206 = " > 0) {" + NL + "    \t\t";
  protected final String TEXT_207 = NL + "    \t\tconn_";
  protected final String TEXT_208 = ".commit();" + NL + "    \t\t";
  ...
  protected final String TEXT_213 = NL + "    \tresourceMap.put(\"finish_";
  protected final String TEXT_214 = "\", true);" + NL + "    \t";
  protected final String TEXT_215 = NL + "\tnb_line_deleted_";
  protected final String TEXT_216 = "=nb_line_deleted_";
  protected final String TEXT_217 = "+ deletedCount_";
  protected final String TEXT_218 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_219 = "=nb_line_update_";
  protected final String TEXT_220 = " + updatedCount_";
  protected final String TEXT_221 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_222 = "=nb_line_inserted_";
  protected final String TEXT_223 = " + insertedCount_";
  protected final String TEXT_224 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_225 = "=nb_line_rejected_";
  protected final String TEXT_226 = " + rejectedCount_";
  protected final String TEXT_227 = ";" + NL + "\t";
  protected final String TEXT_228 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_229 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_230 = "_NB_LINE\",nb_line_";
  protected final String TEXT_231 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_232 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_233 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_234 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_235 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_236 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_237 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_238 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_239 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_240 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_241 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_242 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_243 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_244 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_245 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_246 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_247 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_248 = "_NB_LINE_REJECTED\",nb_line_rejected_";
  protected final String TEXT_249 = "_NB_LINE_REJECTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_250 = "_NB_LINE_REJECTED\") + nb_line_rejected_";
