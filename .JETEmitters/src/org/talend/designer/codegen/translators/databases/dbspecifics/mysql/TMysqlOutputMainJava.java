...
public class TMysqlOutputMainJava {
  ...
  protected final String TEXT_58 = ") {" + NL + "\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_59 = ".getColumnCount(); i++) {" + NL + "\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_60 = ".getColumnMetadata(i);" + NL + "\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_61 = ".execute(((\"";
  protected final String TEXT_62 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_70 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_71 = ";" + NL + "                    if (";
  protected final String TEXT_72 = ") {" + NL + "                        for (int i = 0; i < dynamic_";
  protected final String TEXT_73 = ".getColumnCount(); i++) {" + NL + "                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_74 = ".getColumnMetadata(i);" + NL + "                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_75 = NL;
  protected final String TEXT_76 = NL + "                    String keyCheckTable_";
  protected final String TEXT_77 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_78 = "+\"][\"+";
  protected final String TEXT_79 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_80 = " + \"]\";";
  protected final String TEXT_81 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_82 = " + \"[checktable]\" + \"[\" + ";
  ...
  protected final String TEXT_87 = NL + "                                boolean whetherExist_";
  protected final String TEXT_88 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_89 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_90 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_91 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_92 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_93 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_100 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_101 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_105 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_106 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_107 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_108 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_109 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_110 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_111 = " = rsTable_";
  protected final String TEXT_112 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_113 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_114 = ".equals";
  protected final String TEXT_115 = "IgnoreCase";
  protected final String TEXT_116 = "(";
  protected final String TEXT_117 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_121 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_122 = "((";
  protected final String TEXT_123 = ")";
  protected final String TEXT_124 = ") || (dbschema_";
  protected final String TEXT_125 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_126 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_127 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_128 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_129 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_130 = " == null || dbschema_";
  protected final String TEXT_131 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_132 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_133 = " = stmtSchema_";
  protected final String TEXT_134 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_135 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_136 = " = rsSchema_";
  protected final String TEXT_137 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_138 = ".toLowerCase()";
  protected final String TEXT_139 = ") || ((dbschema_";
  protected final String TEXT_140 = " ==null || dbschema_";
  protected final String TEXT_141 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_142 = "(schema_";
  protected final String TEXT_143 = NL + "                                String tableForSearch_";
  protected final String TEXT_144 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_145 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_146 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_147 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_148 = " =  tableForSearch_";
  protected final String TEXT_149 = ".substring(1,tableForSearch_";
  protected final String TEXT_150 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_151 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_152 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_153 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_154 = ".getTables(null, conn_";
  protected final String TEXT_155 = ".getSchema(), tableForSearch_";
  protected final String TEXT_156 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_157 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_158 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_159 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_160 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_161 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_162 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_163 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_164 = ".getTables(";
  protected final String TEXT_165 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_166 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_167 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_168 = ".equalsIgnoreCase(";
  protected final String TEXT_169 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_170 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_171 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_172 = NL + "                                if(!whetherExist_";
  protected final String TEXT_173 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_182 = NL + "                                if(whetherExist_";
  protected final String TEXT_183 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_184 = NL + "                                                      stmtDrop_";
  protected final String TEXT_185 = NL + "                                        stmtDrop_";
  protected final String TEXT_186 = NL + "                                    }";
  protected final String TEXT_187 = NL + "                                            conn_";
  protected final String TEXT_188 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_189 = NL + "                                                  stmtCreate_";
  protected final String TEXT_190 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_191 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_192 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_193 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_194 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_195 = NL + "                                    stmtCreate_";
  protected final String TEXT_196 = NL + "                                }";
  protected final String TEXT_197 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_198 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_199 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_200 = NL + "                              stmtClear_";
  protected final String TEXT_201 = NL + "                stmtClear_";
  protected final String TEXT_202 = ".executeUpdate(\"";
  protected final String TEXT_203 = "\");";
  protected final String TEXT_204 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_205 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_206 = NL + "                              stmtTruncCount_";
  protected final String TEXT_207 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_208 = " = stmtTruncCount_";
  protected final String TEXT_209 = ".executeQuery(\"";
  protected final String TEXT_210 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_211 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_212 = " = rsTruncCount_";
  protected final String TEXT_213 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_214 = NL + "                              stmtTrunc_";
  protected final String TEXT_215 = NL + "                conn_";
  protected final String TEXT_216 = NL + "                stmtTrunc_";
  protected final String TEXT_217 = NL + "                    if(!conn_";
  protected final String TEXT_218 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_219 = ".commit();" + NL + "                    }";
  protected final String TEXT_220 = NL + "                deletedCount_";
  protected final String TEXT_221 = " += rsTruncCountNumber_";
  protected final String TEXT_222 = ";" + NL + "            }";
  protected final String TEXT_223 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_224 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_229 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_230 = NL + "            StringBuffer duplidateClause_";
  protected final String TEXT_231 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");";
  ...
  protected final String TEXT_235 = " + \"`\");" + NL + "                        duplidateClause_";
  protected final String TEXT_236 = ".append (\"=\");" + NL + "                        duplidateClause_";
  protected final String TEXT_237 = ".append (";
  protected final String TEXT_238 = ";";
  protected final String TEXT_239 = NL + "                insert_";
  protected final String TEXT_240 = " +=  duplidateClause_";
  protected final String TEXT_241 = ".toString();";
  protected final String TEXT_242 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_243 = " = new StringBuffer(insert_";
  protected final String TEXT_244 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_245 = ".insert(insert_";
  protected final String TEXT_246 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_247 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_248 = " =insertStringBuffer_";
  ...
  protected final String TEXT_255 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  ...
  protected final String TEXT_265 = NL + "                ////////////////////////////////////////////////////////////////////////////////////////////" + NL + "" + NL + "" + NL + "                StringBuilder extendInsertValueStmt_";
  protected final String TEXT_266 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_267 = ";i++){";
  protected final String TEXT_268 = NL + "                    extendInsertValueStmt_";
  protected final String TEXT_269 = ".append(\"(";
  protected final String TEXT_270 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_271 = ")+\")\");";
  protected final String TEXT_272 = NL + "                if (i!=";
  protected final String TEXT_273 = "-1) extendInsertValueStmt_";
  protected final String TEXT_274 = ".append(\",\");" + NL + "                }";
  protected final String TEXT_275 = NL + "                        insert_";
  protected final String TEXT_276 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_277 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_278 = "\", ";
  protected final String TEXT_279 = ")+\") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_280 = "    " + NL + "                    pstmt_";
  protected final String TEXT_281 = " =  conn_";
  protected final String TEXT_282 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_283 = NL + NL + "                        insertColName";
  protected final String TEXT_284 = " = \"";
  protected final String TEXT_285 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_286 = "\");" + NL + "                        insertColValue";
  protected final String TEXT_287 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_288 = NL + "                        insertColName";
  protected final String TEXT_289 = " = DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_290 = " = DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_291 = NL + "                rowCount";
  protected final String TEXT_292 = " = 0;";
  protected final String TEXT_293 = NL + "                int rowCount";
  protected final String TEXT_294 = NL + "                        batchSize_";
  protected final String TEXT_295 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_296 = "=0;";
  protected final String TEXT_297 = NL + "                        int batchSize_";
  protected final String TEXT_298 = ";" + NL + "                        int batchSizeCounter_";
  protected final String TEXT_299 = "    " + NL + "                pstmt_";
  protected final String TEXT_300 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_301 = ");" + NL + NL;
  protected final String TEXT_302 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_303 = " = new StringBuffer(update_";
  protected final String TEXT_304 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_305 = ".insert(update_";
  protected final String TEXT_306 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_307 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_308 = " =updateStringBuffer_";
  protected final String TEXT_309 = NL + "        pstmt_";
  protected final String TEXT_310 = ".prepareStatement(update_";
  protected final String TEXT_311 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_312 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_313 = " + \"` WHERE \" + DynamicUtils.getUpdateWhere(";
  protected final String TEXT_314 = "\", new StringBuilder(\"";
  protected final String TEXT_315 = "\"), ";
  protected final String TEXT_316 = "));//String insert_";
  protected final String TEXT_317 = " + \"` (";
  protected final String TEXT_318 = ") VALUES (";
  protected final String TEXT_319 = ")\";" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_320 = "    " + NL + "        pstmtInsert_";
  protected final String TEXT_321 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_322 = "\", pstmtInsert_";
  protected final String TEXT_323 = NL + "        pstmtUpdate_";
  protected final String TEXT_324 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_325 = "\", pstmtUpdate_";
  protected final String TEXT_326 = NL + "            String delete_";
  protected final String TEXT_327 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_328 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_329 = " = new StringBuffer(delete_";
  protected final String TEXT_330 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_331 = ".insert(delete_";
  protected final String TEXT_332 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_333 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_334 = " =deleteStringBuffer_";
  protected final String TEXT_335 = ".toString();  ";
  protected final String TEXT_336 = NL + "        pstmt_";
  protected final String TEXT_337 = ".prepareStatement(delete_";
  protected final String TEXT_338 = ".prepareStatement(replace_";
  protected final String TEXT_339 = ";" + NL + "            insertIgnore_";
  protected final String TEXT_340 = " = insertIgnore_";
  protected final String TEXT_341 = " + \" ON DUPLICATE KEY UPDATE \" + DynamicUtils.getUpdateSet(";
  protected final String TEXT_342 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_343 = "    " + NL + "        pstmt_";
  protected final String TEXT_344 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_345 = " = insert_";
  protected final String TEXT_346 = ".split(\"\\\\?\");";
  protected final String TEXT_347 = NL + "\t\t\tupdate_";
  protected final String TEXT_348 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_349 = " = update_";
  protected final String TEXT_350 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_351 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_352 = NL + "\t\t\tdelete_";
  protected final String TEXT_353 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_354 = " = delete_";
  protected final String TEXT_355 = NL + "\t\t\treplace_";
  protected final String TEXT_356 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_357 = " = replace_";
  protected final String TEXT_358 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_359 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_360 = NL + "        }";
  protected final String TEXT_361 = NL + "                if(";
  protected final String TEXT_362 = "==null){";
  protected final String TEXT_363 = ".setNull(counter";
  protected final String TEXT_364 = ",java.sql.Types.CHAR);";
  protected final String TEXT_365 = ",java.sql.Types.DATE);";
  protected final String TEXT_366 = ",java.sql.Types.ARRAY);";
  protected final String TEXT_367 = ",java.sql.Types.INTEGER);";
  protected final String TEXT_368 = ",java.sql.Types.VARCHAR);";
  protected final String TEXT_369 = ",java.sql.Types.OTHER);";
  protected final String TEXT_370 = ",java.sql.Types.BOOLEAN);";
  protected final String TEXT_371 = ",java.sql.Types.DOUBLE);";
  protected final String TEXT_372 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_373 = NL + "                }else{";
  protected final String TEXT_374 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_375 = ").toLowerCase())){";
  protected final String TEXT_376 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_377 = " == '\\0'){" + NL;
  protected final String TEXT_378 = ".setString(counter";
  protected final String TEXT_379 = ",\"\");" + NL + "" + NL + "                }else{" + NL;
  protected final String TEXT_380 = ",String.valueOf(";
  protected final String TEXT_381 = "));" + NL + "                }";
  protected final String TEXT_382 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_383 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_384 = " < year1_";
  protected final String TEXT_385 = " || date_";
  protected final String TEXT_386 = " >= year10000_";
  protected final String TEXT_387 = ") {";
  protected final String TEXT_388 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_389 = ".setTimestamp(counter";
  protected final String TEXT_390 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_391 = "));" + NL + "                    }" + NL + "                }else{" + NL;
  protected final String TEXT_392 = ",java.sql.Types.DATE);" + NL + "" + NL + "                }";
  protected final String TEXT_393 = ".set";
  protected final String TEXT_394 = "(counter";
  protected final String TEXT_395 = ",";
  protected final String TEXT_396 = NL + NL + "                }" + NL;
  protected final String TEXT_397 = NL + "        query_";
  protected final String TEXT_398 = " = new StringBuffer(\"\");";
  protected final String TEXT_399 = NL + "                commitEvery_";
  protected final String TEXT_400 = " = buffersSize_";
  protected final String TEXT_401 = NL + "                    batchSize_";
  protected final String TEXT_402 = NL + "        whetherReject_";
  protected final String TEXT_403 = " = false;";
  protected final String TEXT_404 = NL + "                        int counter";
  protected final String TEXT_405 = " = rowCount";
  protected final String TEXT_406 = " * ";
  protected final String TEXT_407 = " + 1;";
  protected final String TEXT_408 = NL + "                            counter";
  protected final String TEXT_409 = "++;";
  protected final String TEXT_410 = NL + "                            int count_dyn_";
  protected final String TEXT_411 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_412 = ", counter";
  protected final String TEXT_413 = "-1, \"";
  protected final String TEXT_414 = "\");" + NL + "                            counter";
  protected final String TEXT_415 = "+=count_dyn_";
  protected final String TEXT_416 = NL + NL + "                    exInsertColValue";
  protected final String TEXT_417 = " = new BufferLine_";
  protected final String TEXT_418 = NL + "                                ,";
  protected final String TEXT_419 = NL + "                    , ";
  protected final String TEXT_420 = NL + "                    );" + NL + "" + NL + "                    exInsertColValueList";
  protected final String TEXT_421 = ".add(exInsertColValue";
  ...
  protected final String TEXT_426 = "){" + NL + "                        try{" + NL + "                            insertedCount_";
  protected final String TEXT_427 = " = insertedCount_";
  protected final String TEXT_428 = " + pstmt_";
  protected final String TEXT_429 = ".executeUpdate();" + NL + "                        }catch(java.lang.Exception e){";
  protected final String TEXT_430 = NL + "                             throw e;";
  protected final String TEXT_431 = NL + "                             System.err.println(e.getMessage());";
  protected final String TEXT_432 = NL + "                        }" + NL + "                        exInsertColValueList";
  protected final String TEXT_433 = ".clear();" + NL + "                        rowCount";
  protected final String TEXT_434 = " = 0;" + NL + "                        counter";
  protected final String TEXT_435 = "=1;" + NL + "                    }";
  protected final String TEXT_436 = NL + "                                query_";
  protected final String TEXT_437 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_438 = ", ";
  protected final String TEXT_439 = ",insertSQLSplits_";
  protected final String TEXT_440 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_441 = NL + "                        globalMap.put(\"";
  protected final String TEXT_442 = "_QUERY\", query_";
  protected final String TEXT_443 = ".toString().trim());";
  protected final String TEXT_444 = NL + "                    pstmt_";
  protected final String TEXT_445 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_446 = "++;" + NL + "" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_447 = NL + "                      batchSizeCounter_";
  protected final String TEXT_448 = NL + "                    try {" + NL + "                        nb_line_";
  protected final String TEXT_449 = NL + "                        insertedCount_";
  protected final String TEXT_450 = ".executeUpdate();";
  protected final String TEXT_451 = NL + "                    } catch(java.lang.Exception e) {" + NL + "                        whetherReject_";
  protected final String TEXT_452 = " = true;";
  protected final String TEXT_453 = NL + "                            throw(e);";
  protected final String TEXT_454 = NL + "                                ";
  protected final String TEXT_455 = " = new ";
  protected final String TEXT_456 = "Struct();";
  protected final String TEXT_457 = NL + "                                    ";
  protected final String TEXT_458 = NL + "                                rejectedCount_";
  protected final String TEXT_459 = " =  rejectedCount_";
  protected final String TEXT_460 = "+ 1;";
  protected final String TEXT_461 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_462 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_463 = NL + "                                System.err.print(e.getMessage());";
  protected final String TEXT_464 = NL + "                    }";
  protected final String TEXT_465 = NL + "                            query_";
  protected final String TEXT_466 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_467 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_468 = NL + "                    globalMap.put(\"";
  protected final String TEXT_469 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_470 = NL + "                    insertedCount_";
  ...
  protected final String TEXT_473 = NL + "                            rejectedCount_";
  protected final String TEXT_474 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_475 = NL + "                }";
  protected final String TEXT_476 = NL + "                        query_";
  protected final String TEXT_477 = ",updateSQLSplits_";
  protected final String TEXT_478 = NL + NL + "                int count_";
  protected final String TEXT_479 = "\", true);";
  protected final String TEXT_480 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_481 = ", (count_";
  protected final String TEXT_482 = " + ";
  protected final String TEXT_483 = "), \"";
  protected final String TEXT_484 = NL + "                globalMap.put(\"";
  protected final String TEXT_485 = NL + "            pstmt_";
  protected final String TEXT_486 = ".addBatch();" + NL + "            nb_line_";
  protected final String TEXT_487 = "++;" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_488 = NL + "              batchSizeCounter_";
  protected final String TEXT_489 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_490 = NL + "                updatedCount_";
  protected final String TEXT_491 = " = updatedCount_";
  protected final String TEXT_492 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_493 = NL + "                    throw(e);";
  protected final String TEXT_494 = NL + "                        rejectedCount_";
  protected final String TEXT_495 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_496 = NL + "            }";
  protected final String TEXT_497 = NL + "                    DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_498 = NL + "            int checkCount_";
  protected final String TEXT_499 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_500 = " = pstmt_";
  protected final String TEXT_501 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_502 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_503 = " = rs_";
  protected final String TEXT_504 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_505 = " > 0) {";
  protected final String TEXT_506 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_507 = NL + "                    int count_";
  protected final String TEXT_508 = ", pstmtUpdate_";
  protected final String TEXT_509 = NL + "                                    query_";
  protected final String TEXT_510 = NL + "                    routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_511 = NL + "                try {";
  protected final String TEXT_512 = NL + "                    updatedCount_";
  protected final String TEXT_513 = " + pstmtUpdate_";
  protected final String TEXT_514 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_515 = NL + "                        nb_line_";
  protected final String TEXT_516 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_517 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_518 = ", pstmtInsert_";
  protected final String TEXT_519 = " + pstmtInsert_";
  protected final String TEXT_520 = NL + "                }" + NL + "            }";
  protected final String TEXT_521 = NL + "            int updateFlag_";
  protected final String TEXT_522 = NL + "                int count_";
  protected final String TEXT_523 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_524 = "=pstmtUpdate_";
  protected final String TEXT_525 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_526 = "+updateFlag_";
  protected final String TEXT_527 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_528 = " == 0) {" + NL;
  protected final String TEXT_529 = NL + "                query_";
  protected final String TEXT_530 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_531 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_532 = "++;" + NL + "            \t" + NL + "            \t";
  protected final String TEXT_533 = NL + "            try {";
  protected final String TEXT_534 = NL + "                deletedCount_";
  protected final String TEXT_535 = " = deletedCount_";
  protected final String TEXT_536 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_537 = NL + "                    nb_line_";
  protected final String TEXT_538 = ";" + NL;
  protected final String TEXT_539 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_540 = NL + "            int replaceCount_";
  protected final String TEXT_541 = " = 0;" + NL + "            try {";
  protected final String TEXT_542 = NL + "                replaceCount_";
  protected final String TEXT_543 = NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_544 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_545 = " += replaceCount_";
  protected final String TEXT_546 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_547 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_548 = " - 1;" + NL + "            }";
  protected final String TEXT_549 = " = DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_550 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_551 = NL + "                count_on_duplicate_key_";
  protected final String TEXT_552 = NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_553 = " += count_on_duplicate_key_";
  protected final String TEXT_554 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_555 = NL + "            if(!whetherReject_";
  protected final String TEXT_556 = NL + "                if ( batchSize_";
  protected final String TEXT_557 = " <= batchSizeCounter_";
  protected final String TEXT_558 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_559 = NL + "                        for(int countEach_";
  protected final String TEXT_560 = ": pstmt_";
  protected final String TEXT_561 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_562 = " += (countEach_";
  protected final String TEXT_563 = " == java.sql.Statement.EXECUTE_FAILED ? 0 : 1);" + NL + "                        }";
  protected final String TEXT_564 = " += countSum_";
  protected final String TEXT_565 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_566 = NL + "                    int countSum_";
  protected final String TEXT_567 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_568 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_569 = " < 0 ? 0 : countEach_";
  protected final String TEXT_570 = ");" + NL + "                    }";
  protected final String TEXT_571 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_572 = NL + NL + "                batchSizeCounter_";
  protected final String TEXT_573 = " = 0;" + NL + "            }";
  protected final String TEXT_574 = NL + "                        updatedCount_";
  protected final String TEXT_575 = NL + "                        deletedCount_";
  protected final String TEXT_576 = NL + "                        batchSizeCounter_";
  protected final String TEXT_577 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_578 = NL + "                    deletedCount_";
  protected final String TEXT_579 = NL + NL + NL + NL + "                }";
  protected final String TEXT_580 = NL + "                commitCounter_";
  protected final String TEXT_581 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_582 = " <= commitCounter_";
  protected final String TEXT_583 = ") {" + NL;
  protected final String TEXT_584 = " < 0 ? 0 : ";
  protected final String TEXT_585 = NL + NL + "                }";
  protected final String TEXT_586 = NL + "                    conn_";
  protected final String TEXT_587 = NL + "                    commitCounter_";
  protected final String TEXT_588 = "=0;" + NL + "" + NL + "                }" + NL;
