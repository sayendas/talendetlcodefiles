...
public class TMysqlCommitMainJava
{
  ...
  protected final String TEXT_56 = NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_57 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_58 = "\");" + NL + "" + NL + "if(conn_";
  protected final String TEXT_59 = " != null && !conn_";
  protected final String TEXT_60 = ".isClosed()) {" + NL + "\t";
  protected final String TEXT_61 = NL + "\t\ttry{" + NL + "\t";
