...
public class TMysqlOutputFinallyJava {
  ...
  protected final String TEXT_36 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_37 = "\") == null) {";
  protected final String TEXT_38 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_39 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_40 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_41 = "\")) != null) {" + NL + "                stmtToClose_";
  protected final String TEXT_42 = ".close();" + NL + "            }";
  protected final String TEXT_43 = NL + "                java.sql.PreparedStatement pstmtUpdateToClose_";
  protected final String TEXT_44 = " = null;" + NL + "                if ((pstmtUpdateToClose_";
  protected final String TEXT_45 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_46 = "\")) != null) {" + NL + "                    pstmtUpdateToClose_";
  protected final String TEXT_47 = ".close();" + NL + "                }" + NL + "                java.sql.PreparedStatement pstmtInsertToClose_";
  protected final String TEXT_48 = " = null;" + NL + "                if ((pstmtInsertToClose_";
  protected final String TEXT_49 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_50 = "\")) != null) {" + NL + "                    pstmtInsertToClose_";
  protected final String TEXT_51 = ".close();" + NL + "                }";
  protected final String TEXT_52 = NL + "                java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_53 = " = null;" + NL + "                if ((pstmtToClose_";
  protected final String TEXT_54 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_55 = "\")) != null) {" + NL + "                    pstmtToClose_";
  protected final String TEXT_56 = NL + "    }";
  protected final String TEXT_57 = NL + "    } finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_58 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_59 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_60 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_61 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_62 = NL + "                        if(!ctn_";
  protected final String TEXT_63 = ".getAutoCommit() && !ctn_";
  protected final String TEXT_64 = ".isClosed()) {" + NL + "                            ctn_";
  protected final String TEXT_65 = ".commit();" + NL + "                        }";
  protected final String TEXT_66 = NL + "                    ctn_";
  protected final String TEXT_67 = ".close();";
  protected final String TEXT_68 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_69 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_70 = " = \"failed to close the connection in ";
  protected final String TEXT_71 = " :\" + sqlEx_";
  protected final String TEXT_72 = ".getMessage();";
  protected final String TEXT_73 = NL + "                    System.err.println(errorMessage_";
