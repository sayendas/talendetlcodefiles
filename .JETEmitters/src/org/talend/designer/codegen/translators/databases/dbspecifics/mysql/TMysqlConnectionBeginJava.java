...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_30 = " + \"?\" + \"rewriteBatchedStatements=true\";";
  protected final String TEXT_31 = NL + "\t\tString properties_";
  protected final String TEXT_32 = ";" + NL + "\t\tif (properties_";
  protected final String TEXT_33 = " == null || properties_";
  protected final String TEXT_34 = ".trim().length() == 0) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_35 = " += \"rewriteBatchedStatements=true&allowLoadLocalInfile=true\";" + NL + "\t\t}else if (properties_";
  protected final String TEXT_36 = " != null && !properties_";
  protected final String TEXT_37 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_38 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\tif (properties_";
  protected final String TEXT_39 = ".contains(\"allowLoadLocalInfile\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_40 = " += \"&allowLoadLocalInfile=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString url_";
  protected final String TEXT_41 = " + \"?\" + properties_";
  ...
  protected final String TEXT_57 = " - Retrieving records from the datasource.\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_62 = " - Written records count: \" + nb_line_";
  protected final String TEXT_63 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_64 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_65 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_66 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_67 = " - Writing the record \" + nb_line_";
  protected final String TEXT_68 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_69 = " - Processing the record \" + nb_line_";
  protected final String TEXT_70 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_71 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_72 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_73 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_74 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_75 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_76 = " - Uses an existing connection ";
  protected final String TEXT_77 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_79 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_80 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_81 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_83 = ", dbUser_";
  protected final String TEXT_84 = ", dbPwd_";
  protected final String TEXT_85 = ");" + NL + "\t\t\t";
  protected final String TEXT_86 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_87 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_88 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_90 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\tconn_";
  protected final String TEXT_92 = NL + "\t\t\t\tlog.";
  protected final String TEXT_93 = "(\"";
  protected final String TEXT_94 = " - \" + ";
  protected final String TEXT_95 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_96 = NL + "\t    \t\tlog.";
  protected final String TEXT_97 = "\");" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_99 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_101 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_102 = ": pstmt_";
  protected final String TEXT_103 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_104 = " += (countEach_";
  protected final String TEXT_105 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_109 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_110 = " == null) {";
  protected final String TEXT_111 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_112 = "\", conn_";
  protected final String TEXT_113 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_114 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_115 = ".get(dsAlias_";
  protected final String TEXT_116 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_117 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_118 = " = dataSources_";
  protected final String TEXT_119 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_120 = ");" + NL + "\t}";
  protected final String TEXT_121 = NL + "\tif (null != conn_";
  protected final String TEXT_122 = ") {" + NL + "\t\t";
  protected final String TEXT_123 = NL + "\t}";
  protected final String TEXT_124 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_125 = "\",conn_";
  protected final String TEXT_126 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
