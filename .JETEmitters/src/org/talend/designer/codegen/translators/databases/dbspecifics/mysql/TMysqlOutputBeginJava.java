...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_40 = ";" + NL + "        if(deleteKeyCount_";
  protected final String TEXT_41 = " < 1) {" + NL + "            throw new RuntimeException(\"For delete, Schema must have a key\");" + NL + "        }";
  ...
  protected final String TEXT_45 = " = 0;" + NL + "int nb_line_deleted_";
  ...
  protected final String TEXT_50 = "=0;" + NL + "" + NL + "int rejectedCount_";
  protected final String TEXT_51 = "=0;" + NL + "" + NL + "String tableName_";
  protected final String TEXT_52 = ";" + NL + "boolean whetherReject_";
  protected final String TEXT_53 = " = false;" + NL + "" + NL + "java.util.Calendar calendar_";
  protected final String TEXT_54 = " = java.util.Calendar.getInstance();" + NL + "calendar_";
  protected final String TEXT_55 = ".set(1, 0, 1, 0, 0, 0);" + NL + "long year1_";
  protected final String TEXT_56 = " = calendar_";
  protected final String TEXT_57 = ".getTime().getTime();" + NL + "calendar_";
  protected final String TEXT_58 = ".set(10000, 0, 1, 0, 0, 0);" + NL + "long year10000_";
  protected final String TEXT_59 = ".getTime().getTime();" + NL + "long date_";
  ...
  protected final String TEXT_65 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_66 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_67 = ") {" + NL + "\t\t\tString dsAlias_";
  protected final String TEXT_68 = ";" + NL + "    \t\tif (dataSources_";
  protected final String TEXT_69 = ".get(dsAlias_";
  protected final String TEXT_70 = ") == null) {" + NL + "       \t\t\tthrow new RuntimeException(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_71 = " + \" available!\");" + NL + "          \t}" + NL + "    \t\tconn_";
  protected final String TEXT_72 = " = dataSources_";
  protected final String TEXT_73 = ").getConnection();" + NL + "\t\t} else {";
  protected final String TEXT_74 = NL + "\t\tString dbProperties_";
  protected final String TEXT_75 = ";" + NL + "\t\tString url_";
  protected final String TEXT_76 = " = null;" + NL + "\t\tif(dbProperties_";
  protected final String TEXT_77 = " == null || dbProperties_";
  protected final String TEXT_78 = ".trim().length() == 0) {" + NL + "\t\t\turl_";
  protected final String TEXT_79 = " = \"";
  protected final String TEXT_80 = "://\" + ";
  protected final String TEXT_81 = " + \":\" + ";
  protected final String TEXT_82 = " + \"/\" + ";
  protected final String TEXT_83 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t\t} else {" + NL + "\t\t\tString properties_";
  protected final String TEXT_84 = ";" + NL + "\t\t\tif (!properties_";
  protected final String TEXT_85 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\t\tproperties_";
  protected final String TEXT_86 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\turl_";
  protected final String TEXT_87 = " + \"?\" + properties_";
  protected final String TEXT_88 = ";" + NL + "\t\t}" + NL + "\t\tString driverClass_";
  ...
  protected final String TEXT_99 = ";" + NL + "\t\tjava.lang.Class.forName(driverClass_";
  ...
  protected final String TEXT_110 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_111 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_112 = " = 0;";
  ...
  protected final String TEXT_116 = NL + "int count_";
  protected final String TEXT_117 = NL + "    \t";
  protected final String TEXT_118 = NL + "            try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_122 = ".setQueryTimeout(Integer.valueOf(Integer.valueOf(";
  ...
  protected final String TEXT_130 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_131 = NL + "                              stmtCreate_";
  protected final String TEXT_132 = ".setQueryTimeout(Integer.valueOf(";
  protected final String TEXT_133 = "));";
  protected final String TEXT_134 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_135 = ";" + NL + "\t                    if (";
  protected final String TEXT_136 = ") {" + NL + "\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_137 = ".getColumnCount(); i++) {" + NL + "\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_138 = ".getColumnMetadata(i);" + NL + "\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_139 = ".execute(((\"";
  protected final String TEXT_140 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  ...
  protected final String TEXT_148 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_149 = ";" + NL + "                    if (";
  protected final String TEXT_150 = ") {" + NL + "                        for (int i = 0; i < dynamic_";
  protected final String TEXT_151 = ".getColumnCount(); i++) {" + NL + "                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_152 = ".getColumnMetadata(i);" + NL + "                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_153 = NL;
  protected final String TEXT_154 = NL + "                    String keyCheckTable_";
  protected final String TEXT_155 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_156 = "+\"][\"+";
  protected final String TEXT_157 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_158 = " + \"]\";";
  protected final String TEXT_159 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_160 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_161 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_162 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_163 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_164 = ")== null){//}";
  protected final String TEXT_165 = NL + "                                boolean whetherExist_";
  protected final String TEXT_166 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_167 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_168 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_169 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_170 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_171 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_178 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_179 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_183 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_184 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_185 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_186 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_187 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_199 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_200 = "((";
  protected final String TEXT_201 = ")";
  protected final String TEXT_202 = ") || (dbschema_";
  protected final String TEXT_203 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_204 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_205 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_206 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_207 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_208 = " == null || dbschema_";
  protected final String TEXT_209 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_210 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_211 = " = stmtSchema_";
  protected final String TEXT_212 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_213 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_214 = " = rsSchema_";
  protected final String TEXT_215 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_216 = ".toLowerCase()";
  ...
  protected final String TEXT_221 = NL + "                                String tableForSearch_";
  protected final String TEXT_222 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_223 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_224 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_225 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_226 = " =  tableForSearch_";
  protected final String TEXT_227 = ".substring(1,tableForSearch_";
  protected final String TEXT_228 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_229 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_230 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_231 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_232 = ".getTables(null, conn_";
  protected final String TEXT_233 = ".getSchema(), tableForSearch_";
  protected final String TEXT_234 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_235 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_236 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_237 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_238 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_239 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_240 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_241 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_242 = ".getTables(";
  protected final String TEXT_243 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_248 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_249 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_250 = NL + "                                if(!whetherExist_";
  protected final String TEXT_251 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_252 = NL + "                                                      stmtCreate_";
  protected final String TEXT_253 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_254 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_255 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_256 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_257 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_261 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_266 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_270 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_271 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_272 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_273 = NL + "                                    stmtCreate_";
  protected final String TEXT_274 = NL + "                                }";
  protected final String TEXT_275 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_276 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_277 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_278 = NL + "                              stmtClear_";
  protected final String TEXT_279 = NL + "                stmtClear_";
  protected final String TEXT_280 = ".executeUpdate(\"";
  protected final String TEXT_281 = "\");";
  protected final String TEXT_282 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_283 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_284 = NL + "                              stmtTruncCount_";
  protected final String TEXT_285 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_286 = " = stmtTruncCount_";
  protected final String TEXT_287 = ".executeQuery(\"";
  protected final String TEXT_288 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_289 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_290 = " = rsTruncCount_";
  protected final String TEXT_291 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_292 = NL + "                              stmtTrunc_";
  protected final String TEXT_293 = NL + "                conn_";
  protected final String TEXT_294 = NL + "                stmtTrunc_";
  protected final String TEXT_295 = NL + "                    if(!conn_";
  protected final String TEXT_296 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_297 = ".commit();" + NL + "                    }";
  protected final String TEXT_298 = NL + "                deletedCount_";
  protected final String TEXT_299 = " += rsTruncCountNumber_";
  protected final String TEXT_300 = ";" + NL + "            }";
  protected final String TEXT_301 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_307 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_308 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_309 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_310 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_311 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_312 = ".append (\"`\" +  ";
  protected final String TEXT_313 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_314 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_315 = ".append (";
  protected final String TEXT_316 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_317 = NL + "\t\t        String insert_";
  protected final String TEXT_318 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_319 = " + \"` (";
  protected final String TEXT_320 = ") VALUES (";
  protected final String TEXT_321 = ")\";";
  protected final String TEXT_322 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_323 = " += \tduplidateClause_";
  protected final String TEXT_324 = ".toString();";
  protected final String TEXT_325 = NL + "\t\t\t\t";
  protected final String TEXT_326 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_327 = " = new StringBuffer(insert_";
  protected final String TEXT_328 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_329 = ".insert(insert_";
  protected final String TEXT_330 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_331 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_332 = " =insertStringBuffer_";
  protected final String TEXT_333 = ".toString(); ";
  protected final String TEXT_334 = "    " + NL;
  protected final String TEXT_335 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_336 = ".prepareStatement(insert_";
  protected final String TEXT_337 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_338 = "\", pstmt_";
  protected final String TEXT_339 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_340 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_341 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_342 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_343 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_344 = ",insert_";
  protected final String TEXT_345 = ",keyPsmt_";
  protected final String TEXT_346 = NL + "\t            class BufferLine_";
  protected final String TEXT_347 = " {" + NL + "    \t            ";
  protected final String TEXT_348 = " ";
  protected final String TEXT_349 = ";";
  protected final String TEXT_350 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_351 = NL + "                                ,";
  protected final String TEXT_352 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_353 = NL + "                                this.";
  protected final String TEXT_354 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_355 = "> exInsertColValueList";
  protected final String TEXT_356 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_357 = " exInsertColValue";
  protected final String TEXT_358 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_359 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_360 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_361 = ".append(\"(";
  protected final String TEXT_362 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_363 = "-1) extendInsertValueStmt_";
  protected final String TEXT_364 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_365 = " = \"INSERT INTO `\"+";
  protected final String TEXT_366 = "+\"` (";
  protected final String TEXT_367 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_368 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_369 = " =  conn_";
  protected final String TEXT_370 = ");" + NL + "\t            resourceMap.put(\"pstmt_";
  protected final String TEXT_371 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_372 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_373 = " =  \"";
  protected final String TEXT_374 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_375 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_376 = NL + "\t\t        int batchSize_";
  protected final String TEXT_377 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_378 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_379 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_380 = ");" + NL + "\t\t        resourceMap.put(\"pstmt_";
  protected final String TEXT_381 = ");" + NL;
  protected final String TEXT_382 = NL + "\t    String update_";
  protected final String TEXT_383 = " = \"UPDATE `\" + ";
  protected final String TEXT_384 = " + \"` SET ";
  protected final String TEXT_385 = " WHERE ";
  protected final String TEXT_386 = "\";" + NL + "\t    ";
  protected final String TEXT_387 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_388 = " = new StringBuffer(update_";
  protected final String TEXT_389 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_390 = ".insert(update_";
  protected final String TEXT_391 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_392 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_393 = " =updateStringBuffer_";
  protected final String TEXT_394 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_395 = ".prepareStatement(update_";
  protected final String TEXT_396 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_397 = ");" + NL + "\t    ";
  protected final String TEXT_398 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_399 = " + \"` WHERE ";
  protected final String TEXT_400 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_401 = ");" + NL + "\t    String insert_";
  protected final String TEXT_402 = ")\";" + NL + "\t    ";
  protected final String TEXT_403 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_404 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_405 = "\", pstmtInsert_";
  ...
  protected final String TEXT_408 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_409 = "\", pstmtUpdate_";
  protected final String TEXT_410 = ")\";" + NL + "\t     ";
  protected final String TEXT_411 = NL + "\t    String delete_";
  protected final String TEXT_412 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_413 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_414 = " = new StringBuffer(delete_";
  protected final String TEXT_415 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_416 = ".insert(delete_";
  protected final String TEXT_417 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_418 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_419 = " =deleteStringBuffer_";
  protected final String TEXT_420 = ".toString();  ";
  protected final String TEXT_421 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_422 = ".prepareStatement(delete_";
  protected final String TEXT_423 = NL + "\t    String replace_";
  protected final String TEXT_424 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_425 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_426 = ".prepareStatement(replace_";
  protected final String TEXT_427 = NL + "\t    String insertIgnore_";
  protected final String TEXT_428 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_429 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_430 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_431 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_432 = NL + "\t    String insert_";
  protected final String TEXT_433 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_434 = NL + "        StringBuffer query_";
  protected final String TEXT_435 = " = null;" + NL + "       \t";
  protected final String TEXT_436 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_437 = " = insert_";
  protected final String TEXT_438 = ".split(\"\\\\?\");";
  protected final String TEXT_439 = NL + "\t\t\tupdate_";
  protected final String TEXT_440 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_441 = " = update_";
  protected final String TEXT_442 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_443 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_444 = NL + "\t\t\tdelete_";
  protected final String TEXT_445 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_446 = " = delete_";
  protected final String TEXT_447 = NL + "\t\t\treplace_";
  protected final String TEXT_448 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_449 = " = replace_";
  protected final String TEXT_450 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_451 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_452 = " = insertIgnore_";
  protected final String TEXT_453 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_454 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_455 = ";" + NL + "\t\t\t";
  protected final String TEXT_456 = NL + "\t\t\t\t, routines.system.Dynamic ";
  protected final String TEXT_457 = NL + "\t\t\t";
  protected final String TEXT_458 = NL + "\t\t\t\tthis.";
  protected final String TEXT_459 = "=";
  protected final String TEXT_460 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_461 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_462 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_463 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_464 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_465 = "=1;";
  protected final String TEXT_466 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_467 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_468 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_469 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_470 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_471 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_472 = "=0;" + NL + "\t";
  protected final String TEXT_473 = NL + "\t\tStringBuffer query_";
  ...
  protected final String TEXT_478 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_479 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_480 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_481 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
