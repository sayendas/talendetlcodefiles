...
public class TJoinBeginJava
{
  ...
  protected final String TEXT_5 = "Struct>) globalMap.get(\"tHash_";
  protected final String TEXT_6 = "\");" + NL + "    " + NL + "    class Util_";
  protected final String TEXT_7 = NL + "    {";
  protected final String TEXT_8 = NL + "        ";
  protected final String TEXT_9 = "Struct lookupValue = null;";
  protected final String TEXT_10 = "Struct ";
  protected final String TEXT_11 = "HashKey = new ";
  protected final String TEXT_12 = "Struct(); " + NL + "        " + NL + "        public boolean isJoined(";
  protected final String TEXT_13 = "Struct mainRow) {            ";
  protected final String TEXT_14 = "            ";
  protected final String TEXT_15 = NL + "           ";
  protected final String TEXT_16 = "HashKey.";
  protected final String TEXT_17 = " = mainRow.";
  protected final String TEXT_18 = ";" + NL;
  protected final String TEXT_19 = NL + "\t\t\t";
  protected final String TEXT_20 = "HashKey.hashCodeDirty = true;";
  protected final String TEXT_21 = "\t\t\t             " + NL + "            lookupValue = tHash_";
  protected final String TEXT_22 = ".get(";
  protected final String TEXT_23 = "HashKey);            " + NL + "            if(lookupValue != null){" + NL + "            \treturn true;" + NL + "            }else{" + NL + "            }  " + NL + "            return false;" + NL + "        }" + NL + "    }" + NL + "        " + NL + "\tUtil_";
  protected final String TEXT_24 = " util_";
  protected final String TEXT_25 = " = new Util_";
  protected final String TEXT_26 = "();" + NL + "        " + NL + "    int nb_line_";
